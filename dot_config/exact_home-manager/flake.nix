{
  ...
  inputs = {
    ...
    gamedev-skills-awesome-gamedev-agent-skills = {
      url = "github:gamedev-skills/awesome-gamedev-agent-skills";
      flake = false;
    };
    jetify-com-devbox = {
    ...
    binarywang-WxJava = {
      url = "github:binarywang/WxJava/develop";
      flake = false;
    };
    ...
    JimLiu-baoyu-skills = {
      url = "github:JimLiu/baoyu-skills";
      flake = false;
    };
    ...
    Kotlin-kotlin-agent-skills = {
      url = "github:Kotlin/kotlin-agent-skills";
      flake = false;
    };
    ...
    liqiha0-lifeos-skills = {
      url = "github:liqiha0/lifeos-skills";
      flake = false;
    };
    mattpocock-skills = {
    ...
    Xiangyu-CAS-xiaohongshu-ops-skill = {
      url = "github:Xiangyu-CAS/xiaohongshu-ops-skill";
      flake = false;
    };
    ...
    ZzzLc0405-photo-abstract-editorial = {
      url = "github:ZzzLc0405/photo-abstract-editorial";
      flake = false;
    };
