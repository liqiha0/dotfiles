...

{
  ...
  home.file = {
    ...
    "workspace".source = config.lib.file.mkOutOfStoreSymlink "/Volumes/DATA/workspace";
    ".gradle/caches".source = config.lib.file.mkOutOfStoreSymlink "/Volumes/DATA/.gradle/caches";
    ".gradle/jdks".source = config.lib.file.mkOutOfStoreSymlink "/Volumes/DATA/.gradle/jdks";
    ".lmstudio/models".source = config.lib.file.mkOutOfStoreSymlink "/Volumes/DATA/.lmstudio/models";
    "Library/Android".source = config.lib.file.mkOutOfStoreSymlink "/Volumes/DATA/Library/Android";
  };
}
